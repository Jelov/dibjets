...
#pp
# root -l -q -b buildtuplemc.C+\(\"mcp1qcdak4PF\"\) >out/mcp1qcdak4PF &
# root -l -q -b buildtuplemc.C+\(\"mcp2qcdak4PF\"\) >out/mcp2qcdak4PF &
# root -l -q -b buildtuplemc.C+\(\"mcp3qcdak4PF\"\) >out/mcp3qcdak4PF &

#root -l -q -b buildtuplemc.C+\(\"mcp1bjtak4PF\"\) >out/mcp1bjtak4PF &
#root -l -q -b buildtuplemc.C+\(\"mcp2bjtak4PF\"\) >out/mcp2bjtak4PF &
#root -l -q -b buildtuplemc.C+\(\"mcp3bjtak4PF\"\) >out/mcp3bjtak4PF &

#root -l -q -b buildtuplemc.C+\(\"mXppqcdak4PF\"\) >out/mXppqcdak4PF &
#root -l -q -b buildtuplemc.C+\(\"mXppbjtak4PF\"\) >out/mXppbjtak4PF &
...
#PbPb
#root -l -q -b buildtuplemc.C+\(\"mXPbqcdakPu4PF\"\) >out/mXPbqcdakPu4PF &
#root -l -q -b buildtuplemc.C+\(\"mXPbbjtakPu4PF\"\) >out/mXPbbjtakPu4PF &
