...
root -l -q -b buildtupledata.C+\(\"dtp1jpfak4PF\"\) >out/dtp1jpfak4PF &
root -l -q -b buildtupledata.C+\(\"dtp2jpfak4PF\"\) >out/dtp2jpfak4PF &
root -l -q -b buildtupledata.C+\(\"dtp3jpfak4PF\"\) >out/dtp3jpfak4PF &

#root -l -q -b buildtupledata.C+\(\"dtPbjclakPu4PF\"\) >out/dtPbjclakPu4PF &
#root -l -q -b buildtupledata.C+\(\"dtPbj40akPu4PF\"\) >out/dtPbj40akPu4PF &
# root -l -q -b buildtupledata.C+\(\"dtPbbjtakPu4PF\"\) >out/dtPbbjtakPu4PF &

#root -l -q -b buildtupledata.C+\(\"dtppjpfak3PF\"\) >out/dtppjpfak3PF &
#root -l -q -b buildtupledata.C+\(\"dtPbjclakPu3PF\"\) >out/dtPbjclakPu3PF &
